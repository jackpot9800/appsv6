<?php
// ultra-simple-server.php - Serveur WebSocket ultra simplifié
...
class UltraSimpleServer implements MessageComponentInterface {
    protected $clients;
    ...
    public function onMessage(ConnectionInterface $from, $msg) {
        ...
        // Simplement renvoyer le message à l'expéditeur
        $from->send("Écho: " . $msg);
        
        // Et aussi à tous les autres clients
        foreach ($this->clients as $client) {
            if ($from !== $client) {
                $client->send("Client {$from->resourceId} dit: {$msg}");
            }
        }
    }
